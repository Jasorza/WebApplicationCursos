...
namespace WebApplicationCursos.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CursoID,Nombre,Descripcion,Horas,Costo,Estado,CategoriaID")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CursoID,Nombre,Descripcion,Horas,Costo,Estado,CategoriaID")] Curso curso)
        {
            if (id != curso.CursoID)
            {
                return NotFound();
